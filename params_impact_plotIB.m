...
baselineOF = 0.3591;
perturbedOF_plus = [0.7276, 0.57, 0.3778, 0.3713, 0.3486, 0.35552, 0.3625, 0.3618, 0.3609, 0.3591, 0.3591, 0.3591];
perturbedOF_minus = [0.3588, 0.3526, 0.3671, 0.3457, 0.3695, 0.3647, 0.3618, 0.3625, 0.3606, 0.3591, 0.3591, 0.3591];
