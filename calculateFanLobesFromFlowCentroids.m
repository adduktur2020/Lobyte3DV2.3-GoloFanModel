function [glob, depos, numberOfLobes] = calculateFanLobesFromFlowCentroids(glob, depos)
    ...
    % glob = calculateCentroidsAndFlowOverlapsIB(glob, depos); %THIS IS THE NORMAL I HAVE BEEN USING
    glob = calculateCentroidsAndFlowOverlapsIB3(glob, depos); % THIS INCLUDES ELEVATION POINTS
